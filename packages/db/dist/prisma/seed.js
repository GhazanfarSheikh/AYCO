import { HeatTier, MediaType, PrismaClient, ProductStatus, Role, ThemeMode, } from "@prisma/client";
...
const zones = [
    ...
    },
    {
        ...
        iconKey: "Laptop2",
        imageUrl: "https://images.unsplash.com/photo-1615526675159-e248c3021d3f?auto=format&fit=crop&w=1200&q=80",
        name: "Tech",
        slug: "tech",
        sortOrder: 2,
    },
...
const products = [
    {
        ...
        colors: ["Nebula", "Frost"],
        description: "Noise-cancelling buds that keep lectures crisp, library sessions quiet, and late-night edits less chaotic.",
        dispatchDays: 2,
    ...
    },
    {
        ...
        description: "A charging dock that powers your phone, watch, and earbuds without turning your desk into cable soup.",
        dispatchDays: 1,
    ...
    },
    {
        ...
        description: "A warm-cool desk lamp with focus presets and a tiny footprint for crowded dorm setups.",
        dispatchDays: 2,
    ...
    },
    {
        ...
        description: "A semester-ready note system with magnetic tabs, weekly sprint planners, and dead-simple study sheets.",
        dispatchDays: 1,
    ...
    },
    {
        campusHeat: ["nyu", "lums"],
        colors: ["Cream", "Cedar"],
        description: "A weighted throw that turns a basic twin bed into an actual reset button.",
        dispatchDays: 3,
    ...
    },
    {
        ...
        colors: ["Night", "Olive"],
        description: "Bedside storage for chargers, glasses, water, pens, and whatever else disappears after midnight.",
        dispatchDays: 2,
    ...
    },
    {
        ...
        description: "Double-walled bottle with a built-in hydration reminder band for marathon class days.",
        dispatchDays: 2,
    ...
    },
    {
        campusHeat: ["nyu", "stanford"],
        colors: ["Lime", "Smoke"],
        description: "Compact resistance loops for quick dorm workouts, stretch breaks, and post-class recovery.",
        dispatchDays: 2,
    ...
    },
    {
        campusHeat: ["ucla", "lums"],
        colors: ["Coal", "Sand"],
        description: "Oversized tote with laptop sleeve, water bottle pocket, and enough room for a full day on campus.",
        dispatchDays: 2,
    ...
    },
    {
        ...
        description: "Heavyweight hoodie with a clean campus fit and zero weird shrinkage after laundry day.",
        dispatchDays: 3,
    ...
    },
    {
        ...
        colors: ["Slate", "Lime"],
        description: "Mini kit with earplugs, sleep mask, vitamin pouch, and mint wipes for recovery after chaos.",
        dispatchDays: 1,
    ...
    },
    {
        ...
        colors: ["Sky", "Black"],
        description: "Laundry setup with folding hamper, detergent sheets, and a mesh wash bag for dorm life.",
        dispatchDays: 2,
